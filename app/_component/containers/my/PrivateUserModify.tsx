...
const PrivateUserModify = () => {
  const { labelPosition } = useInputPosition();

  return (
    <form
      className={
        "tablet:w-[460px] web:ml-0 tablet:mx-auto web:min-w-[414px] mobile:w-full flex flex-col gap-6"
      }>
      <Input
        name={"id"}
        value={""}
      ...
      <div className={"flex gap-3 tablet:flex-row mobile:flex-col mt-6"}>
        <Button
          type={"button"}
          title={"취소"}
          onClick={() => {}}
...
export default PrivateUserModify;

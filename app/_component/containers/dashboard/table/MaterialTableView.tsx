...
const headers = [
  ...
  { label: "이미지", rowspan: 4 },
  { label: "소재정보", colspan: 9, rowspan: 1 },
  { label: "소재 품질분석", colspan: 15 },
  { label: "관심소재", rowspan: 4 },
  { label: "제안요청", rowspan: 4 },
];
